...
# -- Project information -----------------------------------------------------
project = "fimage"
html_title = "fimage Documentation"
...
if os.path.exists(os.path.join(os.path.dirname(__file__), "_doxygen", "xml")):
    breathe_projects = {"fimage": "_doxygen/xml"}
else:
    breathe_projects = {"fimage": "../build/doxygen/xml"}
breathe_default_project = "fimage"
...
extlinks = {
    ...
    "github": ("https://github.com/NKI-AI/fimage/%s", "%s"),
    "issue": ("https://github.com/NKI-AI/fimage/issues/%s", "Issue %s"),
}
...
# -- OpenGraph settings -----------------------------------------------------
ogp_site_url = "https://docs.aifo.dev/fimage/"
ogp_description_length = 200
ogp_image = "https://docs.aifo.dev/fimage/_static/fimage-social.png"
ogp_image_alt = "fimage - Tile-based Image Processing"
ogp_type = "website"
